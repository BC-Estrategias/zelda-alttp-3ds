...
- Fixed the New 3DS graphical regression introduced by shared PPU optimizations after v2.0.
- Removed the unsafe experimental scanline cache from the shared renderer.
