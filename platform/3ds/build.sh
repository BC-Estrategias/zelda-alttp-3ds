...
"${BANNERTOOL}" makesmdh \
  -s "A Link to the Past 3DS v2.9" \
  -l "A Link to the Past 3DS v2.9" \
...
(
  ...
  "${MAKEROM}" \
    -f cia \
    -o "${GAME_BUILD}/zelda3-3ds-v2.9.cia" \
...
printf 'Listos:\n'
printf '  %s\n' "${GAME_BUILD}/zelda3-3ds-v2.9.3dsx"
printf '  %s\n' "${GAME_BUILD}/zelda3-3ds-v2.9.cia"
