...
"${BANNERTOOL}" makesmdh \
  -s "A Link to the Past 3DS v3.3" \
  -l "A Link to the Past 3DS v3.3" \
...
(
  ...
  "${MAKEROM}" \
    -f cia \
    -o "${GAME_BUILD}/zelda3-3ds-v3.3.cia" \
...
printf 'Listos:\n'
printf '  %s\n' "${GAME_BUILD}/zelda3-3ds-v3.3.3dsx"
printf '  %s\n' "${GAME_BUILD}/zelda3-3ds-v3.3.cia"
