...
static void Draw3DSVersionOverlay(uint8 *pixels, int pitch,
  ...
  int text_w = IntMax(TinyTextWidth("VERSION 2.3 EXP", scale),
  ...
  DrawTinyText(pixels, pitch, width, height, "VERSION 2.3 EXP",
               x + (box_w - TinyTextWidth("VERSION 2.3 EXP", scale)) / 2,
